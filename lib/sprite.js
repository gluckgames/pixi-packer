...
module.exports = class Sprite {
    ...
    createAndProcessScaledVersions() {
        ...
        return Promise.all(_.map(this.scaledSprites, scaledSprite => scaledSprite.process()));
    }
    ...
    process() {
        ...
        .then(this.createAndProcessScaledVersions.bind(this))
        .then(() => this);
    };
};
